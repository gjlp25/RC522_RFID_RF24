...
#define wifi_ssid WIFI_SSID                // use define from secrets.h
#define wifi_password WIFI_PASSWORD        // use define from secrets.h

#define mqtt_server MQTT_SERVER           // use define from secrets.h
#define mqtt_user MQTT_USER               // use define from secrets.h
#define mqtt_password MQTT_PASSWORD       // use define from secrets.h
...
void setup() {
  ...
  ArduinoOTA.setPassword(OTA_PASSWORD);    // use OTA password from secrets.h
...
void MQTT_sensorData5() {
  ...
  String payloadString = "{\"card_id\":\"" + String(cardIdString) + 
                        "\",\"authorized\":\"" + String(sensorData5.authorized ? "yes" : "no") + 
